...
API = bitmex.bitmex(test=True, api_key='T0d6UlOga1YmPs66RBak9Bka', api_secret='AdAYbADyZfs3NewtCzZdRwl6fHjjg4B9d0iJqkRFxoyPtB88')
...
TrailPeg = 0  # トレーリングストップの価格追従距離。(ドル単位)
